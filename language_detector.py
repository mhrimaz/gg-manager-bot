...
class LanguageDetector:
    ...
    def _calculate_languages_ratios(self, text):
        """
        Calculate likelyhood of a given text to be written in several languages and
...
if __name__ == '__main__':
    ...
    text1 = "Kamran you suck"
    text2 = "kamran ridi"

    detector = LanguageDetector()
    language = detector.detect(text1)
    print(text1 + ": " + language)

    language = detector.detect(text2)
